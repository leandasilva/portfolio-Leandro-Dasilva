...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1a2e] via-[#533483] to-[#0f3460] text-white p-6 flex flex-col items-center">
  {/* Foto de perfil */}
  <img
    src="/leandro.jfif"  // Poné aquí la ruta de tu foto en /public
    alt="Leandro Da Silva"
    className="w-42 h-42 rounded-full border-4 border-white mb-6 shadow-lg"
  />
